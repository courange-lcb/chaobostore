...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(150, 110, 401, 121))
        ...
        self.stackedWidget_2.setGeometry(QtCore.QRect(120, 322, 461, 111))
        ...
        self.gridLayout_2 = QtWidgets.QGridLayout(self.stackedWidget_2Page1)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.pushButton_4 = QtWidgets.QPushButton(self.stackedWidget_2Page1)
        self.pushButton_4.setObjectName("pushButton_4")
        self.gridLayout_2.addWidget(self.pushButton_4, 0, 0, 1, 1)
        self.pushButton_5 = QtWidgets.QPushButton(self.stackedWidget_2Page1)
        self.pushButton_5.setObjectName("pushButton_5")
        self.gridLayout_2.addWidget(self.pushButton_5, 0, 1, 1, 1)
        self.pushButton_6 = QtWidgets.QPushButton(self.stackedWidget_2Page1)
        self.pushButton_6.setObjectName("pushButton_6")
        self.gridLayout_2.addWidget(self.pushButton_6, 0, 2, 1, 1)
        self.lineEdit_3 = QtWidgets.QLineEdit(self.stackedWidget_2Page1)
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.gridLayout_2.addWidget(self.lineEdit_3, 1, 0, 1, 2)
        self.lineEdit_4 = QtWidgets.QLineEdit(self.stackedWidget_2Page1)
